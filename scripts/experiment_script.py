...
T = 0.5
H_original = 900  # limit
K_original = 1000.0  # strike
...
#                        pass
# make_experiment(T, H_original, K_original, r_premia, V0, kappa, theta, sigma, rho, N, M, L)
make_premialike_answers_for_folder("../output/experiment/", iterations=10, start_price=900, end_price=1100)
